export function HeroSection() {
  return (
    <section id="hero" className="min-h-[532px] bg-[#F8F8FF] flex flex-col items-center justify-center relative">
      ...
      <div className="absolute inset-0 w-full flex justify-between item">
